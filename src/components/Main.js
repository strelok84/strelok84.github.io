    ...
    return(
        <div>
            ...
            <section className="about">
                ...
                <label htmlFor="hd-2" >Roadmap от уважаемого <a href="https://github.com/kamranahmedse/kamranahmedse.github.io">kamranahmedse</a></label>
                <div>
                <img src="img/frontendScheme.png" alt="схема_развития" className="scheme__about" srcSet="img\frontendScheme.webp" />
                </div>
